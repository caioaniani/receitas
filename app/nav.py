...
AREAS = [
    {'slug': 'lojas', 'titulo': 'Lojas', 'icone': '🏪', 'cor': '#ffc107',
     'desc': 'Acompanhe pedidos, confira o estoque e organize a rotina das lojas',
     'pode': lambda u: u.pode_lojas()},
    {'slug': 'producao', 'titulo': 'Produção', 'icone': '🥖', 'cor': '#198754',
     'desc': 'Planeje o dia, confirme a produção e separe os pedidos das lojas',
    ...
    {'slug': 'vendas', 'titulo': 'Vendas & Entregas', 'icone': '🛒',
     'cor': '#6f42c1', 'desc': 'Acompanhe as vendas do caixa, os pedidos do site e as entregas',
