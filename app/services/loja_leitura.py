"""Leituras em lote da vitrine e dos kits, descartadas ao terminar o render.
...
@contextmanager
def catalogo_em_lote(*, dias=31, base=None, produtos=None):
    ...
    # A home já usa a lista pública para agrupar os produtos. O mesmo
    # catálogo alimenta os kits sem consultar e serializar tudo novamente.
    if produtos is None:
