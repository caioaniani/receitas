...
_SYSTEM_DESPERDICIO = (
    ...
    'A retirada exige FOTO da sobra, mas foto e quantidade podem vir em '
    'MENSAGENS SEPARADAS: se o usuario ja mandou uma foto nesta conversa, '
    'NAO peca de novo — chame criar_retirada_sobras direto (o sistema anexa '
    'automaticamente a ultima foto que ele mandou no canal). So peca a foto '
    'quando NENHUMA foi enviada. '
    'Se a mensagem for sobre sobra/vencido/descarte/"sobrou no balcao", '
