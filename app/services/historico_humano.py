...
TIPOS_MOV_LOJA = {
    ...
    'venda_site': 'Venda no site (loja própria)',
    'venda_site_estorno': 'Estorno de venda do site',
    'venda_site_sem_estoque': 'Venda do site sem estoque',
    'desperdicio': 'Desperdício',
    'desperdicio_sem_estoque': 'Desperdício sem estoque',
    'desperdicio_estorno': 'Estorno de desperdício',
    'sobra_retorno': 'Sobra convertida em retorno (saída do fresco)',
    'sobra_retorno_sem_estoque': 'Sobra convertida — saldo subcontado',
    'sobra_retorno_entrada': 'Sobra convertida em retorno (entrada)',
    ...
    'ajuste_conferencia': 'Conferência (contagem)',
    'perda_sem_estoque': 'Perda sem saldo',
    'sobra_sem_estoque': 'Sobra sem saldo',
    'descarte_sem_estoque': 'Descarte sem saldo',
    'ajuste_sem_estoque': 'Ajuste sem saldo',
}

TIPOS_MOV_PRODUCAO = {
    'entrada': 'Entrada na indústria',
    'saida_pedido': 'Saída para pedido',
    'saida_pedido_sem_estoque': 'Saída p/ pedido sem saldo',
    'estorno_saida_pedido': 'Estorno de saída p/ pedido',
    'ajuste': 'Ajuste',
