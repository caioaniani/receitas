...
def separar(id):
    ...
    if pedido.status not in _A_SEPARAR:
        ...
        return redirect(url_for('padeiro_testes.index', data=data_str))
...
@padeiro_testes_bp.route('/b2b/<int:id>/separar', methods=['POST'])
@login_required
@padeiro_required
def separar_b2b(id):
...
@padeiro_testes_bp.route('/b2b/<int:id>/entregue', methods=['POST'])
@login_required
@padeiro_required
def entregar_b2b(id):
...
@padeiro_testes_bp.route('/<int:id>/gerar-qr', methods=['POST'])
@login_required
@padeiro_required
def gerar_qr(id):
    ...
    return render_template('padeiro_testes/qr.html', pedido=pedido, drv=drv,
                           qr=qr, url=url, qr_png=qr_png, voltar_data=data_str)


@padeiro_testes_bp.route('/juntar-repetidos', methods=['POST'])
@login_required
@padeiro_required
...
@padeiro_testes_bp.route('/avisos.json')
@login_required
@padeiro_required
def avisos_json():
...
@padeiro_testes_bp.route('/avisos/<int:id>/confirmar', methods=['POST'])
@login_required
@padeiro_required
...
@padeiro_testes_bp.route('/avisos-24h.json')
@login_required
@padeiro_required
def avisos_24h_json():
...
@padeiro_testes_bp.route('/preparar.json')
@login_required
@padeiro_required
def preparar_json():
...
@padeiro_testes_bp.route('/congelados.json')
@login_required
@padeiro_required
def congelados_json():
...
@padeiro_testes_bp.route('/buscar-receitas.json')
@login_required
@padeiro_required
def buscar_receitas():
...
@padeiro_testes_bp.route('/produzir', methods=['POST'])
@login_required
@padeiro_required
def produzir():
...
@padeiro_testes_bp.route('/producao-historico.json')
@login_required
@padeiro_required
