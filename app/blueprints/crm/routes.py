        ...
        with app.app_context():
            ...
            with _lock_conv, _lock_conv_cross_worker(conv_id):
                ...
                try:
                    ...
                    anotar_mesmo_calado = False
                    if (resultado.get('acao') in ('responder', 'handoff', 'encerrar')
                        ...
                        # e antes de RESOLVER por cima da equipe. O handoff
                        # ainda deixa a nota interna (relato/candidata).
