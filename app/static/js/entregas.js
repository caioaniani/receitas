(function() {
            ...
            html += '<div class="card mb-2">' +
                '<div class="card-body py-2 px-3">' +
                    '<div class="d-flex justify-content-between align-items-start">' +
                        ...
                        '<div>' +
                            '<a href="' + linkAdminPedido(p) + '" target="_blank" rel="noopener" class="text-decoration-none" title="Abrir o pedido" style="color: var(--accent);">' +
    ...
    function opRenderItem(p, driver, driversDisp, foraJanela) {
        ...
        html += '<a href="' + linkAdminPedido(p) + '" target="_blank" rel="noopener" class="text-decoration-none small fw-bold" style="color:var(--accent);">' +
        ...
        if (foraJanela) html += ' <span class="badge bg-warning text-dark" style="font-size:10px;" title="Janela mais cedo depois de uma mais tarde na sequência — confira se o horário fecha. A ordem vale assim mesmo."><i class="bi bi-exclamation-triangle"></i> confira a janela</span>';
